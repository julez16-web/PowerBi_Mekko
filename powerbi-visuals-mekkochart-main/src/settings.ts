...
export class LabelsSettings extends FormattingSettingsSimpleCard {
    ...
    public contentMode = new formattingSettings.AutoDropdown({
        name: "contentMode",
    ...
    public autoHideSmallSegments = new formattingSettings.ToggleSwitch({
        name: "autoHideSmallSegments",
        displayNameKey: "Visual_AutoHide_SmallSegments",
        value: true
    });

    public minSegmentThreshold = new formattingSettings.NumUpDown({
        name: "minSegmentThreshold",
        displayNameKey: "Visual_MinSegment_Threshold",
        value: 0.03,
        options: {
            minValue: {
                type: powerbi.visuals.ValidatorType.Min,
    ...
    public slices: FormattingSettingsSlice[] = [
        this.contentMode,
        this.position,
        this.autoHideSmallSegments,
        this.minSegmentThreshold,
        this.color,
        this.fontControl,
        this.displayUnits,
        this.labelPrecision,
...
export class CategoryAxisSettings extends FormattingSettingsSimpleCard {
    ...
    public sortBy = new formattingSettings.AutoDropdown({
        name: "sortBy",
        displayNameKey: "Visual_SortBy",
        value: "widthValue"
    });

    public enableTopN = new formattingSettings.ToggleSwitch({
        name: "enableTopN",
        displayNameKey: "Visual_EnableTopN",
        value: false
    });

    public topNCount = new formattingSettings.NumUpDown({
        name: "topNCount",
        displayNameKey: "Visual_TopN_Count",
        value: 10,
        options: {
            minValue: {
                type: powerbi.visuals.ValidatorType.Min,
    ...
    public showOtherCategory = new formattingSettings.ToggleSwitch({
        name: "showOtherCategory",
        displayNameKey: "Visual_ShowOther",
        value: true
    });

    public otherCategoryLabel = new formattingSettings.TextInput({
        name: "otherCategoryLabel",
        displayNameKey: "Visual_OtherLabel",
        value: "Other",
        placeholder: "Other"
    });
...
export class VisualFormattingSettingsModel extends FormattingSettingsModel {
    ...
    public setVisibilityOfFileds(data: MekkoColumnChartData): void {
        ...
        // Show/hide label-related settings
        if (this.labels.show.value) {
            this.labels.contentMode.visible = true;
            this.labels.position.visible = true;
            this.labels.autoHideSmallSegments.visible = true;
            this.labels.minSegmentThreshold.visible = this.labels.autoHideSmallSegments.value;
        } else {
            this.labels.contentMode.visible = false;
        ...
        if (this.categoryAxis.enableTopN.value) {
            this.categoryAxis.topNCount.visible = true;
            this.categoryAxis.showOtherCategory.visible = true;
            this.categoryAxis.otherCategoryLabel.visible = this.categoryAxis.showOtherCategory.value;
        } else {
            this.categoryAxis.topNCount.visible = false;
            this.categoryAxis.showOtherCategory.visible = false;
            this.categoryAxis.otherCategoryLabel.visible = false;
        }
    }
}
